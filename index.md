...
venue: "Data Carpentry at OSU Center for Health Sciences (TULSA)"        # brief name of host site without address (e.g., "Euphoric State University")
address: "Classroom T-353, Tandy Building, OSU Center For Health Science, 1111 W. 17th St. Tulsa, OK 74107"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
humandate: "April 18-19, 2019"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "8:30 am - 4:00 pm"    # human-readable times for the workshop (e.g., "9:00 am - 4:30 pm")
...
instructor: ["Kay Bjornen","Ki Cole","Gautham Ponnaganti","Phillip Doehle"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Hua Lin","Evan Linde","Michael Anderson", "Kevin Drees", "Peter Hoyt", "Gerwald Koehler"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
collaborative_notes: https://tiger.hpc.okstate.edu/sites/etherpad/p/2019-04-18-okstate-tulsa            # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document
eventbrite: "58724005080"           # optional: alphanumeric key for Eventbrite registration, e.g., "1234567890AB" (if Eventbrite is being used)
---
